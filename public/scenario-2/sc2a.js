...
function sc2aAnimations1() {
    ...
    terms.innerHTML = 
    '<b>Before you go to the bank of your choice to open your first bank account, you\'ll need to bring: </b>' +
    "<ul> </ul> <br />" +
    ...
    nextButton.onclick = function() {sc2aAnimations2()};
}


// animates the tips for opening a bank account 
function sc2aAnimations2() {
    const topDiv = document.getElementById("sc2a-top-div");
